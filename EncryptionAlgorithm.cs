...
namespace VaultCrypt
{
    public class EncryptionAlgorithm
    {
        public sealed record EncryptionAlgorithmInfo(byte ID, string Name, Func<IEncryptionAlgorithmProvider> Provider)
        {
            ...
            public static readonly EncryptionAlgorithmInfo Twofish128CTR = new(10, "Twofish-128-CTR", () => new TwofishProvider(16, new TwofishCtr()));
            public static readonly EncryptionAlgorithmInfo Twofish192CTR = new(11, "Twofish-192-CTR", () => new TwofishProvider(24, new TwofishCtr()));
            public static readonly EncryptionAlgorithmInfo Twofish256CTR = new(12, "Twofish-256-CTR", () => new TwofishProvider(32, new TwofishCtr()));
            public static readonly EncryptionAlgorithmInfo Threefish256CTR = new(13, "Threefish-128-CTR", () => new ThreefishProvider(32, new ThreefishCtr(256)));
            public static readonly EncryptionAlgorithmInfo Threefish512CTR = new(14, "Threefish-192-CTR", () => new ThreefishProvider(64, new ThreefishCtr(512)));
            public static readonly EncryptionAlgorithmInfo Threefish1024CTR = new(15, "Threefish-256-CTR", () => new ThreefishProvider(128, new ThreefishCtr(1024)));
            public static readonly EncryptionAlgorithmInfo Serpent128GCM = new(16, "Serpent-128-GCM", () => new SerpentProvider(16, new SerpentGcm()));
            public static readonly EncryptionAlgorithmInfo Serpent192GCM = new(17, "Serpent-192-GCM", () => new SerpentProvider(24, new SerpentGcm()));
            public static readonly EncryptionAlgorithmInfo Serpent256GCM = new(18, "Serpent-256-GCM", () => new SerpentProvider(32, new SerpentGcm()));
            public static readonly EncryptionAlgorithmInfo Serpent128CTR = new(19, "Serpent-128-CTR", () => new SerpentProvider(16, new SerpentCtr()));
            public static readonly EncryptionAlgorithmInfo Serpent192CTR = new(20, "Serpent-192-CTR", () => new SerpentProvider(24, new SerpentCtr()));
            public static readonly EncryptionAlgorithmInfo Serpent256CTR = new(21, "Serpent-256-CTR", () => new SerpentProvider(32, new SerpentCtr()));
            public static readonly EncryptionAlgorithmInfo Camelia128GCM = new(22, "Camelia-128-GCM", () => new CameliaProvider(16, new CameliaGcm()));
            public static readonly EncryptionAlgorithmInfo Camelia192GCM = new(23, "Camelia-192-GCM", () => new CameliaProvider(24, new CameliaGcm()));
            public static readonly EncryptionAlgorithmInfo Camelia256GCM = new(24, "Camelia-256-GCM", () => new CameliaProvider(32, new CameliaGcm()));
            public static readonly EncryptionAlgorithmInfo Camelia128OCB = new(25, "Camelia-128-OCB", () => new CameliaProvider(16, new CameliaOcb()));
            public static readonly EncryptionAlgorithmInfo Camelia192OCB = new(26, "Camelia-192-OCB", () => new CameliaProvider(24, new CameliaOcb()));
            public static readonly EncryptionAlgorithmInfo Camelia256OCB = new(27, "Camelia-256-OCB", () => new CameliaProvider(32, new CameliaOcb()));
            public static readonly EncryptionAlgorithmInfo Camelia128CTR = new(28, "Camelia-128-CTR", () => new CameliaProvider(16, new CameliaCtr()));
        ...
        public enum EncryptedOutputOrder
        {
            IV_Tag_Data,
            IV_Data_Tag
        }
