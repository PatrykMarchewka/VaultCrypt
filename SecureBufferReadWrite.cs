...
namespace VaultCrypt
{
    ...
    public class SecureBufferReadWrite
    {
        public class SecureBufferReader
        {
            ...
            public SecureBufferReader(ISecureBuffer buffer)
            {
            ...
            {
                if (_data.AsSpan.Length == _index) throw new InvalidOperationException("Cannot read next byte from data");
                return _data.AsSpan[_index++];
            }
            ...
            public ISecureBuffer ReadBytes(int length)
            {
                ...
                _data.AsSpan.Slice(_index, length).CopyTo(result.AsSpan);
                _index += length;
                return result;
            }
            ...
            public ushort ReadUInt16()
            {
                ...
                ushort value = BinaryPrimitives.ReadUInt16LittleEndian(_data.AsSpan.Slice(_index, sizeof(ushort)));
            ...
            public uint ReadUInt32()
            {
                ...
                uint value = BinaryPrimitives.ReadUInt32LittleEndian(_data.AsSpan.Slice(_index, sizeof(uint)));
                _index += sizeof(uint);
                return value;
            }
            ...
            public ulong ReadUInt64()
            {
                ...
                ulong value = BinaryPrimitives.ReadUInt64LittleEndian(_data.AsSpan.Slice(_index, sizeof(ulong)));
                _index += sizeof(ulong);
                return value;
            }
        }
        ...
        public class SecureBufferWriter
        {
            ...
            public SecureBufferWriter(ISecureBuffer data)
            {
            ...
            public void WriteSpan(ReadOnlySpan<byte> value)
            {
                ...
                value.CopyTo(_data.AsSpan.Slice(_index));
                _index += value.Length;
            }
            ...
            public void WriteUInt16(ushort value)
            {
                ...
                BinaryPrimitives.WriteUInt16LittleEndian(_data.AsSpan.Slice(_index), value);
                _index += sizeof(ushort);
            }
            ...
            public void WriteUInt32(uint value)
            {
                ...
                BinaryPrimitives.WriteUInt32LittleEndian(_data.AsSpan.Slice(_index), value);
                _index += sizeof(uint);
            }
