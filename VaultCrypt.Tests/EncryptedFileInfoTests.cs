...
namespace VaultCrypt.Tests
{
    ...
    {
        [Fact]
        internal void InitializedEmpty()
        {
        ...
        internal void FormatSizeFormatsCorrectly_Bytes(ulong size, string expected)
        {
        ...
        internal void FormatSizeFormatsCorrectly_Kilobytes(ulong size, string expected)
        {
            var result = new EncryptedFileInfo(null, size, null);
            Assert.Equal(expected, result.FileSize);
        }
        ...
        internal void FormatSizeFormatsCorrectly_Megabytes(ulong size, string expected)
        {
            var result = new EncryptedFileInfo(null, size, null);
            Assert.Equal(expected, result.FileSize);
        }
        ...
        internal void FormatSizeFormatsCorrectly_Gigabytes(ulong size, string expected)
        {
            var result = new EncryptedFileInfo(null, size, null);
            Assert.Equal(expected, result.FileSize);
        }
        ...
        internal void FormatSizeFormatsCorrectly_Terabytes(ulong size, string expected)
        {
            var result = new EncryptedFileInfo(null, size, null);
            Assert.Equal(expected, result.FileSize);
        }
        ...
        internal void FormatSizeFormatsCorrectly_Petabytes(ulong size, string expected)
        {
            var result = new EncryptedFileInfo(null, size, null);
            Assert.Equal(expected, result.FileSize);
        }
        ...
        internal void FormatSizeFormatsCorrectly_Exabytes(ulong size, string expected)
        {
            var result = new EncryptedFileInfo(null, size, null);
            Assert.Equal(expected, result.FileSize);
        }
