...
namespace VaultCrypt.Tests.Services
{
    public class FakeFileService : IFileService
    {
        ...
        public void WriteReadyChunk(ConcurrentDictionary<ulong, SecureBuffer.SecureLargeBuffer> results, ref ulong nextToWrite, ulong currentIndex, Stream fileFS, object lockObject) => WriteReadyChunkWasCalled = true;
