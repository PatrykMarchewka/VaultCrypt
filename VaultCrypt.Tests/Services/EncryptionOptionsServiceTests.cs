...
namespace VaultCrypt.Tests.Services
{
    public class EncryptionOptionsServiceTests
    {
        ...
        void GetDecryptedFileEncryptionOptionsDecryptsCorrectly()
        {
            ...
            EncryptionOptions.FileEncryptionOptions expected = new EncryptionOptions.FileEncryptionOptions(0, new byte[13] { 116, 109, 112, 99, 103, 103, 99, 98, 105, 46, 116, 109, 112 }, 60, 0, false, null); //FileName = tmpcggcbi.tmp
