...
namespace VaultCrypt.Tests
{
    public class VaultSessionTests : IDisposable
    {
        ...
        [Fact]
        public void CreateSessionSetsValuesCorrectly()
        {
        ...
        [Fact]
        public void RaiseEncryptedFileListUpdatedRaisesEvent()
        {
    ...
    public class VaultRegistryTests
    {
        ...
        [Fact]
        public void GetVaultReaderReturnsCorrectValue()
        {
        ...
        [Fact]
        public void GetVaultReaderThrowsForNonExistentReader()
        {
    ...
    public abstract class VaultReaderTests<TSelf> where TSelf : VaultReaderTests<TSelf>, IDisposable, new()
    {
        ...
        [Fact]
        public void ReadSaltThrowsForInvalidStream()
        {
        ...
        [Fact]
        public void ReadIterationsNumberThrowsForInvalidStream()
        {
        ...
        [Fact]
        public void PrepareVaultHeaderThrowsForInvalidSalt()
        {
        ...
        [InlineData(-1)]
        [InlineData(0)]
        public void PrepareVaultHeaderThrowsForInvalidIterations(int iterations)
        {
        ...
        [Fact]
        public void ReadMetadataOffsetsThrowsForInvalidStream()
        {
            Assert.Throws<ArgumentNullException>(() => Reader.ReadMetadataOffsets(null!));
        }

        [Fact]
        public void AddAndSaveMetadataOffsetsAddsCorrectly()
        {
            var stream = new MemoryStream();
            stream.WriteByte(0); //First byte is the vault version;
            stream.Write(new byte[Reader.SaltSize]);
        ...
        [Fact]
        public void AddAndSaveMetadataOffsetsThrowsForInvalidStream()
        {
        ...
        [InlineData(-1)]
        [InlineData(0)]
        public void AddAndSaveMetadataOffsetsThrowsForInvalidNewOffset(long newOffset)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Reader.AddAndSaveMetadataOffsets(new MemoryStream(), newOffset));
        }

        [Fact]
        public void RemoveAndSaveMetadataOffsetsRemovesCorrectly()
        {
            var stream = new MemoryStream();
            stream.WriteByte(0); //First byte is the vault version;
            stream.Write(new byte[Reader.SaltSize]);
        ...
        [Fact]
        public void RemoveAndSaveMetadataOffsetsThrowsForInvalidStream()
        {
        ...
        [Fact]
        public void SaveMetadataOffsetsSavesCorrectly()
        {
            var stream = new MemoryStream();
            stream.WriteByte(0); //First byte is the vault version;
            stream.Write(new byte[Reader.SaltSize]);
        ...
        [Fact]
        public void SaveMetadataOffsetsReplacesAlreadyExistingOffsets()
        {
            var stream = new MemoryStream();
            stream.WriteByte(0); //First byte is the vault version;
            stream.Write(new byte[Reader.SaltSize]);
        ...
        [Fact]
        public void ReadAndDecryptDataThrowsForInvalidStream()
        {
        ...
        [InlineData(long.MinValue)]
        [InlineData(-1)]
        public void ReadAndDecryptDataThrowsForInvalidOffset(long offset)
        {
        ...
        [InlineData(-1)]
        [InlineData(0)]
        public void ReadAndDecryptDataThrowsForInvalidLength(int length)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Reader.ReadAndDecryptData(new MemoryStream(), 1, length));
        }

        [Fact]
        public void ReadAndDecryptDataThrowsForTooShortLength()
        {
        ...
        public void VaultEncryptionThrowsForInvalidData(byte[] data)
        {
